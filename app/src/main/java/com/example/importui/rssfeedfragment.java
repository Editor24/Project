...
public class rssfeedfragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_rssfeed,container,false);
        //inflater.inflate(R.layout.fragment_rssfeed,container,false);
        return view;
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception>
    {
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("https://psychcentral.com/blog/feed/?category_name=depression");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(getView().getContext(), android.R.layout.simple_list_item_1, titles);
